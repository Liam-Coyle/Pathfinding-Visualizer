...
function openMoreInfo(algorithm)
{
    ...
    switch (algorithm)
    {
        case 'dijkstras':
            ...
            info.innerHTML = '<img src = "Gifs/Pathfinding/dijkstras.gif" alt = "Animation of dijkstra\'s pathfinding algorithm"></img>' + 
            '<h3>Description</h3>' + 
        ...
        case 'aStar':
            ...
            info.innerHTML = '<img src = "Gifs/Pathfinding/aStar.gif" alt = "Animation of A star pathfinding algorithm"></img>' + 
            '<h3>Description</h3>' + 
            ...
            case 'breadthFirstSearch':
                ...
                info.innerHTML = '<img src = "Gifs/Pathfinding/breadthFirstSearch.gif" alt = "Animation of breadth-first search pathfinding algorithm"></img>' + 
                '<h3>Description</h3>' + 
            ...
            info.innerHTML = '<img src = "Gifs/Pathfinding/depthFirstSearch.gif" alt = "Animation of depth-first search pathfinding algorithm"></img>' + 
            '<h3>Description</h3>' + 
        ...
        case 'recursiveDivision':
            ...
            info.innerHTML = '<img src = "Gifs/MazeGeneration/recursiveDivision.gif" alt = "Animation of recursive division maze generation algorithm"></img>' + 
            '<h3>Description</h3>' + 
        ...
        case 'recursiveBacktracking':
            ...
            info.innerHTML = '<img src = "Gifs/MazeGeneration/recursiveBacktracking.gif" alt = "Animation of recursive backtracking maze generation algorithm"></img>' + 
            '<h3>Description</h3>' + 
